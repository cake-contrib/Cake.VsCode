...
var solutionPath        = "./Source/Cake.VsCode";
var sourcePath          = "./Source";
var binDir              = "./Source/Cake.VsCode/bin/" + configuration;
    ...
    .Does(() =>
{
    ...
    InspectCode(solution, new InspectCodeSettings() {
	  ...
	  Profile = sourcePath + "/Cake.VsCode.sln.DotSettings",
    ...
    .Does(() =>
{
    ...
    var package = buildArtifacts + "/Cake.VsCode." + semVersion + ".nupkg";
