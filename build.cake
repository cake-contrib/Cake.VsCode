...
var solution            = "./Source/Cake.VsCode.sln";
var solutionPath        = Directory("./Source/Cake.VsCode");
var sourcePath          = Directory("./Source");
var binDir              = Directory("./Source/Cake.VsCode/bin") + Directory(configuration);
...
var nuGetPackSettings   = new NuGetPackSettings {
                                ...
                                Summary                 = "Cake AddIn that extends Cake with ability to execute the VsCode command line tool vsce",
                                ProjectUrl              = new Uri("https://github.com/gep13/Cake.VsCode/"),
                                LicenseUrl              = new Uri("https://github.com/gep13/Cake.VsCode/blob/master/LICENSE"),
                                Copyright               = assemblyInfo.Copyright,
                                ReleaseNotes            = new List<string>() { "https://github.com/gep13/Cake.VsCode/releases" },
                                Tags                    = new [] {"Cake", "Script", "Build", "VsCode"},
                                RequireLicenseAcceptance= false,
                                Symbols                 = false,
                                NoPackageAnalysis       = true,
                                Files                   = new [] {
                                                                    new NuSpecContent {Source = "Cake.VsCode.dll"},
                                                                    new NuSpecContent {Source = "Cake.VsCode.pdb"},
                                                                    new NuSpecContent {Source = "Cake.VsCode.xml"}
                                                                 },
                                BasePath                = binDir,
    ...
    .Does(() =>
{
    ...
    InspectCode(solution, new InspectCodeSettings() {
	  ...
	  Profile = sourcePath + File("Cake.VsCode.sln.DotSettings"),
    ...
    .Does(() =>
{
    ...
    var package = buildArtifacts + File("./Cake.VsCode." + semVersion + ".nupkg");
